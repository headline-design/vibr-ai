...
export const metadata: Metadata = {
  title: "Legal Documents | Vibr",
  description: "Legal documents including Terms of Service and Privacy Policy for Vibr",
}
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground">
            These legal documents govern your use of Vibr. Please read them carefully.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>The terms and conditions that govern your use of Vibr</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                ...
                and our commitment to protecting your privacy while using Vibr.
              </p>
            </CardContent>
            <CardFooter>
              <Button asChild>
