...
// Import the MessageActionButtons component
...
interface MessageBubbleProps {
  ...
  onRegenerate?: () => void
  onShare?: () => void
  onAction?: (action: string, messageId: string) => void // Add this line
  ...
  return (
    <div
      className={cn(
        ...
        "rounded-md shadow-md", // Standardize border radius and shadows
        {
          "max-w-[85%] sm:max-w-[75%]": isUser || isAssistant,
          "max-w-full": isSystem,
          "bg-blue-50/90 text-gray-800 border border-blue-100/80": isUser,
          "bg-gray-50/90 text-gray-800 border border-gray-200/80": isAssistant,
          "bg-gray-100/60 text-gray-500 italic": isSystem,
          "dark:bg-gray-800/95 dark:text-white dark:border-gray-700/80": isAssistant,
          "dark:bg-blue-900/30 dark:text-white dark:border-blue-900/50": isUser,
        },
      )}
      tabIndex={0}
    ...
    >
      {message.isThinking ? (
        ...
        <>
          ...
          {/* Find the end of the message content before the timestamp and message actions */}
          {/* Add this after the message content (right before the timestamp section) */}
